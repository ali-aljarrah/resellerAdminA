<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account.aspx.cs" Inherits="resellerAdminA.account" %>
                                                          ...
                                                          <div class="mb-6">
                                                            ...
                                                            <div class="mt-5">
                                                                <form action="#">
                                                                    <div class="row my-4">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="mb-5">
                                                                                ...
                                                                                <input class="form-control form-custom-input" value="" type="date" name="accountAccountManager" id="accountAccountManager" placeholder="Enter user birthday date">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="mb-5">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-grad py-2 px-8 rounded-1" id="editAccountInfoSubmitBtn">
                                                          ...
                                                          <div class="mb-6">
                                                            ...
                                                            <div class="mt-5">
                                                                <form action="#">
                                                                    <div class="row my-4">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="mb-5">
                                                                                ...
                                                                                <input class="form-control form-custom-input" value="Administrator" type="text" name="contactPosition" id="contactPosition" placeholder="Enter user position">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="mb-5">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-grad py-2 px-8 rounded-1" id="editContactDetailsSubmitBtn">
                                                                        <span class="indicator-label">Save changes</span>
                                                                        <span class="indicator-progress">
                                                                            <span class="spinner-border text-white" role="status">
                                                                                <span class="visually-hidden">Loading...</span>
                                                          ...
                                                          <div class="mb-6">
                                                            ...
                                                            <div class="mt-5">
                                                                <form action="#">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-grad py-2 px-8 rounded-1" id="changePasswordSubmitBtn">
