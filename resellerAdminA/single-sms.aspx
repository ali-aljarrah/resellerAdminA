<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="single-sms.aspx.cs" Inherits="resellerAdminA.single_sms" %>
    ...
    <form action="#" id="frmSendSingleSms" name="frmSendSingleSms" runat="server" novalidate="novalidate">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Dashboard" childPageText="Single SMS" />
                <!--end::Header-->
                <!--begin::Wrapper-->
