<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sendbulk.aspx.cs" Inherits="resellerAdminA.sendbulk" %>
    ...
    <form action="#" id="frmSendSingleSms" name="frmSendSingleSms" novalidate="novalidate" runat="server">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Dashboard" childPageText="Send Bulk" />
                <!--end::Header-->
                <!--begin::Wrapper-->
