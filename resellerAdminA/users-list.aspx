...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Users List" childPageText="Dashboard" />
            <!--end::Header-->
            <!--begin::Wrapper-->
                        ...
                        <div class="row my-4 p-8">
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    ...
                                    <input required class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserFullName" id="newUserFullName" placeholder="Enter new user full name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserEmail" class="form-label required">Email</label>
                                    <input required class="form-control form-custom-input mt-3 p-2" value="" type="email" name="newUserEmail" id="newUserEmail" placeholder="Enter new user email">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserPhoneNumber" class="form-label required">Phone number</label>
                                    <input required class="form-control form-custom-input mt-3 p-2" value="" type="text" onkeypress="return goodchars(event,'0123456789,+');" name="newUserPhoneNumber" id="newUserPhoneNumber" placeholder="Enter new user phone number">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserAddress" class="form-label">Address</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserAddress" id="newUserAddress" placeholder="Enter new user address">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserCity" class="form-label">City</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserCity" id="newUserCity" placeholder="Enter new user city">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserState" class="form-label">State</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserState" id="newUserState" placeholder="Enter new user state">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
