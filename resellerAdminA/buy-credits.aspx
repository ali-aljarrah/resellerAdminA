						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
                                    <div class="row g-5 g-xl-10 d-flex">
                                        <div class="col-xl-9">
										    <!--begin::Row-->
                                          ...
                                          <div class="row mb-5" data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
                                                   ...
                                                   <label class="form-check-image w-100">
                                                         <div class="form-check-wrapper p-5">
                                                           <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                            ...
                                                            <p class="color-black-1 fs-25 fw-bold mb-0">$25,000</p>
                                                       </div>
                                                   </label>
                                               </div>
                                                  <!--end::Col-->
                                                   ...
                                                   <label class="form-check-image w-100">
                                                         <div class="form-check-wrapper p-5">
                                                           <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                            ...
                                                            <p class="color-black-1 fs-25 fw-bold mb-0">$50,000</p>
                                                       </div>
                                                   </label>
                                               </div>
                                                  <!--end::Col-->
                                                      ...
                                                      <label class="form-check-image w-100">
                                                            <div class="form-check-wrapper p-5">
                                                              <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                               ...
                                                               <p class="color-black-1 fs-25 fw-bold mb-0">$100,000</p>
                                                          </div>
                                                      </label>
                                                  </div>
                                                  <!--end::Col-->
                                                      ...
                                                      <label class="form-check-image w-100">
                                                            <div class="form-check-wrapper p-5">
                                                              <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                               ...
                                                               <p class="color-black-1 fs-25 fw-bold mb-0">$250,000</p>
                                                          </div>
                                                      </label>
                                                  </div>
                                                  <!--end::Col-->
                                                  ...
                                                  <label class="form-check-image w-100">
                                                        <div class="form-check-wrapper p-5">
                                                          <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                           ...
                                                           <p class="color-black-1 fs-25 fw-bold mb-0">$500,000</p>
                                                      </div>
                                                  </label>
                                              </div>
                                                  <!--end::Col-->
                                                        ...
                                                        <label class="form-check-image w-100">
                                                              <div class="form-check-wrapper p-5">
                                                                <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                                 ...
                                                                 <p class="color-black-1 fs-25 fw-bold mb-0">$1,000,000</p>
                                                            </div>
                                                        </label>
                                                    </div>
                                                  <!--end::Col-->
                                                     ...
                                                     <label class="form-check-image w-100">
                                                           <div class="form-check-wrapper p-5">
                                                             <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                              ...
                                                              <p class="color-black-1 fs-25 fw-bold mb-0">$1,500,000</p>
                                                         </div>
                                                     </label>
                                                 </div>
                                                  <!--end::Col-->
                                                     ...
                                                     <label class="form-check-image w-100">
                                                           <div class="form-check-wrapper p-5">
                                                             <div class="form-check-label form-check-custom form-check-solid justify-content-between">
                                                              ...
                                                              <p class="color-black-1 fs-25 fw-bold mb-0">$</p>
                                                         </div>
                                                     </label>
                                                 </div>
                                                  <!--end::Col-->
                                              ...
                                              <div class="pt-1 mb-5">
                                                  <button type="submit" id="export" name="export" value="Export" class="btn btn-primary btn-grad py-3 pe-5 rounded-1" fdprocessedid="3fvavj">
                                              ...
                                              <hr class="mt-5 mb-5 pt-5 pb-5" />
                                               <!--begin::Page title-->
                                                 <div class="p-5">
                                                     ...
                                                     <!--begin::Card body-->
                                                         <div class="card card-flush pb-4 mt-0 ps-0 pr-0">
                                       ...
                                       <div class="col-xl-3 mb-md-0 mt-5 mt-md-0">
                                            <div class="card card-flush shadow-xs h-100 border-0 mt-5">
