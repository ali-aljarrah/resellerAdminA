<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy-credits.aspx.cs" Inherits="resellerAdminA.buy_credits" %>
    ...
    <form action="#" id="frmReload" name="frmReload" novalidate="novalidate" runat="server">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Dashboard" childPageText="Buy Credits" />
                <!--end::Header-->
                <!--begin::Wrapper-->
