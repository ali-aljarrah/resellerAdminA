<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="general-settings.aspx.cs" Inherits="resellerAdminA.general_settings" %>
    ...
    <form action="#" name="frmSettings" id="frmSettings" runat="server">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Dashboard" childPageText="General Settings" />
                <!--end::Header-->
                <!--begin::Wrapper-->
