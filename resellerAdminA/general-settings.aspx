                                                                ...
                                                                <div class="col-md-8">
                                                                  ...
                                                                  <div class="card shadow-xs p-5 d-flex my-5">
                                                                    ...
                                                                    <form action="#">
                                                                        <div class="row my-4">
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <input required class="form-control-solid form-control" value="Tesla X Inc." type="text" name="businessName" id="businessName" placeholder="Enter your business name">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="supportEmail" class="form-label required">Support email</label>
                                                                                    <input required class="form-control-solid form-control" value="alexflynch@gmail.com" type="email" name="supportEmail" id="supportEmail"  placeholder="Enter business support email">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="defaultSenderID" class="form-label required">Default sender ID</label>
                                                                                    <input required class="form-control-solid form-control" value="TeslaX" type="text" name="defaultSenderID" id="defaultSenderID" placeholder="Your default sender ID">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="businessAddress" class="form-label required">Business address</label>
                                                                                    <input required class="form-control-solid form-control" value="Office K-420-69, 69th floor, Wayne Enterprise, Gotham" type="text" name="businessAddress" id="businessAddress" placeholder="Your business address">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="businessWebsite" class="form-label required">Website</label>
                                                                                    <input required class="form-control-solid form-control" value="www.teslax.com" type="text" name="businessWebsite" id="businessWebsite" placeholder="Your business website">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="resellerDomain" class="form-label required">Reseller domain</label>
                                                                                    <input required class="form-control-solid form-control" value="teslaxx.com" type="text" name="resellerDomain" id="resellerDomain" placeholder="Your business reseller domain">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="businessSignature" class="form-label required">Signature</label>
                                                                                    <input required name="businessSignature" id="businessSignature" type="file" accept="image/*" class="form-control form-control-solid">
                                                                                </div>
                                                                                <div class="my-5">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <input required name="businessLogo" id="businessLogo" type="file" accept="image/*" class="form-control form-control-solid">
                                                                                </div>
                                                                                <div class="my-5">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary py-2 px-8 rounded-1" id="editBusinissSubmitBtn">
                                                                        ...
                                                                        <div class="row my-4">
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <select name="billingModel" id="billingModel" class="form-select form-select-solid">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <select name="hideRegistrationForm" id="hideRegistrationForm" class="form-select form-select-solid">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <select name="enableEmailVerification" id="enableEmailVerification" class="form-select form-select-solid">
                                                                                        <option value="no" selected>No</option>
                                                                                        <option value="yes">Yes</option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <select name="enablePhoneVerification" id="enablePhoneVerification" class="form-select form-select-solid">
                                                                                        <option value="no" selected>No</option>
                                                                                        <option value="yes">Yes</option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <input class="form-control-solid form-control" value="" type="text" name="googleReCaptchaKey" id="googleReCaptchaKey" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="googleReCaptchaSecret" class="form-label">Google reCaptcha secret</label>
                                                                                    <input class="form-control-solid form-control" value="" type="text" name="googleReCaptchaSecret" id="googleReCaptchaSecret" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="disableFundingByCreditPurchases" class="form-label">Disable funding by credit purchases</label>
                                                                                    <select name="disableFundingByCreditPurchases" id="disableFundingByCreditPurchases" class="form-select form-select-solid">
                                                                                        <option value="no" selected>No</option>
                                                                                        <option value="yes">Yes</option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <select name="sendCustomersToWebsiteAfterLogout" id="sendCustomersToWebsiteAfterLogout" class="form-select form-select-solid">
                                                                                        <option value="no" selected>No</option>
                                                                                        <option value="yes">Yes</option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    ...
                                                                                    <input class="form-control-solid form-control" value="" type="number" name="invoiceTax" id="invoiceTax" placeholder="Set to zero to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="my-5">
                                                                                    <label for="invoiceVat" class="form-label">Invoice VAT (%)</label>
                                                                                    <input class="form-control-solid form-control" value="" type="number" name="invoiceVat" id="invoiceVat" placeholder="Set to zero to disable feature">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                                            <button type="button" class="btn btn-primary py-2 px-8 rounded-1" id="otherSettingsSubmitBtn">
                                                                    ...
                                                                    <form action="#">
                                                                        <div class="row my-4">
                                                                            <div class="col-lg-6">
                                                                                <div class="mb-5">
                                                                                    ...
                                                                                    <input class="form-control-solid form-control" value="" type="number" name="smtpServer" id="smtpServer" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="mb-5">
                                                                                    <label for="smtpUsername" class="form-label">SMTP username</label>
                                                                                    <input class="form-control-solid form-control" value="" type="text" name="smtpUsername" id="smtpUsername" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="mb-5">
                                                                                    <label for="smtpPassword" class="form-label">SMTP password</label>
                                                                                    <input class="form-control-solid form-control" value="" type="text" name="smtpPassword" id="smtpPassword" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="mb-5">
                                                                                    <label for="smtpPort" class="form-label">SMTP port</label>
                                                                                    <input class="form-control-solid form-control" value="" type="number" name="smtpPort" id="smtpPort" placeholder="Leave empty to disable feature">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                                <div class="mb-5">
                                                                                    <label for="smtpSecurity" class="form-label">SMTP security</label>
                                                                                    <select name="smtpSecurity" id="smtpSecurity" class="form-select form-select-solid">
                                                                                        <option value="no" selected>No</option>
                                                                                        <option value="yes">Yes</option>
                                                                                    </select>
                                                                                </div>
                                                                        ...
                                                                        <div>
                                                                            <button type="button" class="btn btn-primary py-2 px-8 rounded-1" id="outgoingEmailSettingsSubmitBtn">
                                                                                <span class="indicator-label">Save settings</span>
                                                                                <span class="indicator-progress">
                                                                                    <span class="spinner-border text-white" role="status">
                                                                                        <span class="visually-hidden">Loading...</span>
                                                                            ...
                                                                            <div class="mb-6 px-5">
                                                                               <div class="card shadow-xs p-5 d-flex">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        Format: JPG, GIF, PNG, WEPB or SVG
                                                                                        </li>
                                                                                        <li class="fs-14 dark-color mb-4">
                                                                                        Maximum size: 2MB; Ideal size: at least 160 x 80 pixels
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                            <div class="mb-6 p-5">
                                                                                 <div class="card shadow-xs p-5 d-flex">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <li class="fs-14 dark-color mb-4">
                                                                                        Maximum size: 2MB; Ideal size: at least 200 x 40 pixels
                                                                                        </li>
                                                                                    </ul>
                                                                                 </div>
                                                                            </div>
