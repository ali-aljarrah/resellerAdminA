<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="resellerAdminA.register" %>
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bg-gradient order-1 order-lg-2">
					...
					<div class="d-flex justify-content-center align-items-center flex-column py-7 py-lg-15 px-5 px-lg-20 w-100">
                        <div class="px-lg-20 px-5">
                            <div>
                                <img class="img-fluid" width="580" height="431" loading="lazy" src="assets/img/login-image.png" alt="Login image" />
                            </div>
                            <!--begin::Title-->
