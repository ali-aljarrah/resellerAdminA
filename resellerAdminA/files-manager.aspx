<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="files-manager.aspx.cs" Inherits="resellerAdminA.files_manager" %>
    ...
    <form name="frmSend" id="frmSend" runat="server" method="POST" enctype="multipart/form-data" action="/files-manager.aspx">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:menuTop runat="server" ID="menuTop1" parentPageText="Dashboard" childPageText="Files Manager" />
                <!--end::Header-->
                <!--begin::Wrapper-->
